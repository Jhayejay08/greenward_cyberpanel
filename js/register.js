  ...
  import { getDatabase, set, ref, get, child, onValue, update, remove, push} from "https://www.gstatic.com/firebasejs/10.7.1/firebase-database.js";
  ...
  let RegisterUser = evt=>{
      ...
      .then((credentials)=>{
          ...
          .then(()=>{
            ...
            const phoneNumber = '+63' + trimmedPhone.substring(1);
      ...
      window.displayFirebaseDataSound = function() {
          ...
          function savePhoneNumbers(phoneNumbers) {
            ...
            set(emergencyContactsRef, phoneNumbers)
              ...
              // })
              .then(()=>{
                  const trimmedPhoneNumber = document.getElementById('editphone').value.trim();
